...
class TestConfigForwarding(AcceleratorTestBase):
    """The daemon is launched with the client's identity-affecting config."""

    def _accelerator_flags_for(self, **client_options):
        ...
        with CrossSync._Sync_Impl.DataClient(
    ...
    def test_effective_scopes_forwarded_by_default(self):
    ...
    def test_app_profile_forwarded_to_daemon(self, instance_id, table_id):
